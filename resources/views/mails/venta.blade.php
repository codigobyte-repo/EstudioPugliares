    ...
    <body>
        <div class="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
            <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                <h3 class="text-2xl">Nueva Venta realizada en Estudio Pugliares Web</h3>
                ...
                <p class="text-2xl"><span class="text-semibold">Vendiste:</span> {{ $titulo }} </p>
                <p class="text-1xl"><span class="text-semibold">Precio:</span> {{ $precio }}</p>
                <div class="mt-4">
