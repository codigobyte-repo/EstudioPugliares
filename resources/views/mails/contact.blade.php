    ...
    <body>
        <div class="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
            <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                <h3 class="text-2xl">Recibiste un mensaje en el sitio web Estudio Pugliares</h3>
                ...
                <p class="text-2xl"><span class="text-semibold">Te contactó:</span> {{ $nombre }} {{ $apellido }}</p>
                <p class="text-1xl"><span class="text-semibold">Email:</span> {{ $email }}</p>
                <p class="text-1xl"><span class="text-semibold">Whatsapp:</span> {{ $whatsapp }}</p>
                <p class="text-1xl"><span class="text-semibold">Mensaje:</span> {{ $mensaje }}</p>
                <div class="mt-4">
                    <a href="http//www.estudiopugliares.com.ar" class="px-2 py-2 bg-black text-white">Ir al sitio Web</a>
                    <p class="mt-4 text-sm">¡Accede a ver el mensaje o respondele directamente desde tu correo electrónico!</p>
                </div>
            </div>
        </div>
